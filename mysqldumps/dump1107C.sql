...
INSERT INTO `avgnumofproductsperpackage` VALUES (651,-1),(701,-1);
...
CREATE TABLE `fixedinternetservice` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_servicePkg` int DEFAULT NULL,
...
INSERT INTO `fixedinternetservice` VALUES (1,701,5,40),(2,701,4,10);
...
INSERT INTO `fixedphoneservice` VALUES (1,NULL,1500,100,0,0),(2,NULL,5000,500,1,2);
...
INSERT INTO `mobileinternetservice` VALUES (1,NULL,20,2),(2,NULL,50,3);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `createUpdateSales` AFTER UPDATE ON `order` FOR EACH ROW begin
    if NEW.confirmed=true then
        insert into salesPackage(package_id)
        values (NEW.serviceId);
    end if;
...
INSERT INTO `product` VALUES (1,'iphone 13',15,NULL),(2,'macbook',25,NULL),(3,'xiaomi 11',10,NULL),(4,'ipad 2019',20,NULL),(5,'airpods',5,NULL),(6,'samsung tablet',18,NULL);
...
INSERT INTO `service_package` VALUES (651,'pack1',NULL),(701,'pack2',NULL);
...
--
-- Table structure for table `service_package_validity_periods`
--

DROP TABLE IF EXISTS `service_package_validity_periods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `service_package_validity_periods` (
  `servicePackage_id` int DEFAULT NULL,
  `validityPeriod_id` int DEFAULT NULL,
  KEY `service_package_validity_periods_service_package_id_fk` (`servicePackage_id`),
  KEY `service_package_validity_periods_validityperiod_id_fk` (`validityPeriod_id`),
  CONSTRAINT `service_package_validity_periods_service_package_id_fk` FOREIGN KEY (`servicePackage_id`) REFERENCES `service_package` (`id`),
  CONSTRAINT `service_package_validity_periods_validityperiod_id_fk` FOREIGN KEY (`validityPeriod_id`) REFERENCES `validityperiod` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `service_package_validity_periods`
--

LOCK TABLES `service_package_validity_periods` WRITE;
/*!40000 ALTER TABLE `service_package_validity_periods` DISABLE KEYS */;
INSERT INTO `service_package_validity_periods` VALUES (651,1),(651,2),(651,3),(701,2),(701,3);
/*!40000 ALTER TABLE `service_package_validity_periods` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `createOrderAndAssociatedServicePackageAndValPeriod` AFTER INSERT ON `service_package_validity_periods` FOR EACH ROW begin
...
INSERT INTO `totalpurchaseperpackage` VALUES (651,0),(701,0);
...
INSERT INTO `totalPurchasePerPackAndValidityPeriod` VALUES (651,1,0),(651,2,0),(651,3,0),(701,2,0),(701,3,0);
...
INSERT INTO `user` VALUES (1,'salvatore','buono','tottobuono','0807mary',0,0),(2,NULL,NULL,'ciao','ciao',0,0),(3,NULL,NULL,'test','test',0,0);
...
INSERT INTO `validityperiod` VALUES (1,20,12),(2,18,24),(3,15,36),(4,30,12);
...
-- Dump completed on 2022-07-11 18:21:07
