...
@Entity
@NamedQuery(name="TotalPurchasePackageAndValidity.findAll",
        query= "select p from TotalPurchasePackageAndValidity p")
@NamedQuery(name="TotalPurchasePackageAndValidity.findByPackage",
        query= "select p from TotalPurchasePackageAndValidity p where p.package_id=:package_id")
@NamedQuery(name="TotalPurchasePackageAndValidity.findByValidity",
        query= "select p from TotalPurchasePackageAndValidity p where p.valPeriod_id=:valPeriod_id")
